 ...
 * 
 */
@WebServiceClient(name = "CalculadoraWSService", targetNamespace = "http://calculadorawebservice.ipli.tsi.ifms.br/", wsdlLocation = "http://localhost:8080/calcws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORAWSSERVICE_QNAME = new QName("http://calculadorawebservice.ipli.tsi.ifms.br/", "CalculadoraWSService");
    ...
    public CalculadoraWS getCalculadoraWSPort() {
        return super.getPort(new QName("http://calculadorawebservice.ipli.tsi.ifms.br/", "CalculadoraWSPort"), CalculadoraWS.class);
    }
    ...
    public CalculadoraWS getCalculadoraWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculadorawebservice.ipli.tsi.ifms.br/", "CalculadoraWSPort"), CalculadoraWS.class, features);
    }
